...
print("PRESS 2 TO ADD VIEW LIST")
...
while True:
    ...
    if start == "1":
        ...
        another = input("PRESS 2 TO ADD TO LIST OR 9 TO SELECT ANOTHER OPTION: ")
        if another == "2":
            add_item()
            break
        elif another == "9":
